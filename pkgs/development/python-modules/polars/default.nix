...
buildPythonPackage {
  ...
  # polars will compile the arrow2 crate with the `simd`
  # feature, which requires rust nightly features.
  RUSTC_BOOTSTRAP = 1;

  nativeBuildInputs = with rustPlatform; [ cmake cargoSetupHook maturinBuildHook ];
